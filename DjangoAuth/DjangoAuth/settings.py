...
SECRET_KEY = 'django-insecure-c(e7%4a1qkeqec_nzw#g*y#zo3@%0(mich3tiffe_pj%hs3+i+'

# SECURITY WARNING: don't run with debug turned on in productipython manage.py
DEBUG = True
ALLOWED_HOSTS = []
...
#we add AUTH_USER_MODEL config to specify our custom user model instead of Django built-in User model. 
